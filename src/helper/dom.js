import { isArray, isString, makeArray } from 'helper/utils';
import { addEventCache, removeEventCache } from 'helper/event';
...
const _textAttrName = 'textContent' in _divEl ? 'textContent' : 'innerText';
...
export function query (selector, container = document, toArray) {
  ...
  return toArray ? makeArray(retNodeList) : retNodeList;
}
